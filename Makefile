...
# Archivos fuente
SRC = ft_isascii.c ft_toupper.c ft_tolower.c ft_isdigit.c ft_isalpha.c ft_isalnum.c \
		ft_isprint.c ft_strlen.c ft_bzero.c ft_memset.c ft_memcpy.c ft_strchr.c ft_strrchr.c \
		ft_memcmp.c ft_calloc.c ft_strdup.c ft_putchar_fd.c ft_putstr_fd.c ft_putendl_fd.c \
		ft_putnbr_fd.c ft_substr.c ft_strtrim.c ft_striteri.c ft_strmapi.c ft_strjoin.c \
